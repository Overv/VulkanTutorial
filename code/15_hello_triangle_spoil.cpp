...
private:
    ...
    VkSemaphore gbl_15_imageAvailableSemaphore;
    VkSemaphore gbl_15_renderFinishedSemaphore;
    VkFence gbl_15_inFlightFence;
    ...
    void cleanup_00() {
        vkDestroySemaphore(gbl_04_device, gbl_15_renderFinishedSemaphore, nullptr);
        vkDestroySemaphore(gbl_04_device, gbl_15_imageAvailableSemaphore, nullptr);
        vkDestroyFence(gbl_04_device, gbl_15_inFlightFence, nullptr);
