...
struct Vertex_18 {
    ...
    bool operator==(const Vertex_18& other) const {
        return pos == other.pos && color == other.color && texCoord == other.texCoord;
    }
};

namespace std {
    template<> struct hash<Vertex_18> {
        size_t operator()(Vertex_18 const& vertex) const {
...
private:
    ...
    void cleanupSwapChain_17() {
        ...
        vkDestroyImageView(gbl_04_device, colorImageView, nullptr);
        vkDestroyImage(gbl_04_device, colorImage, nullptr);
        vkFreeMemory(gbl_04_device, colorImageMemory, nullptr);
    ...
    void createImageView_S_07() {
        ...
        for (uint32_t i = 0; i < gbl_06_swapChainImages.size(); i++) {
            gbl_07_swapChainImageViews[i] = createImageView(gbl_06_swapChainImages[i], gbl_06_swapChainImageFormat, VK_IMAGE_ASPECT_COLOR_BIT, 1);
        }
    }
    ...
    void createRenderPass_11() {
        ...
        colorAttachmentResolve.format = gbl_06_swapChainImageFormat;
    ...
    void createColorResources() {
        VkFormat colorFormat = gbl_06_swapChainImageFormat;

        createImage(gbl_06_swapChainExtent.width, gbl_06_swapChainExtent.height, 1, msaaSamples, colorFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT | VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, colorImage, colorImageMemory);
    ...
    void createDepthResources() {
        ...
        createImage(gbl_06_swapChainExtent.width, gbl_06_swapChainExtent.height, 1, msaaSamples, depthFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, depthImage, depthImageMemory);
    ...
    void createTextureImage_24() {
        ...
        createImage(texWidth, texHeight, mipLevels, VK_SAMPLE_COUNT_1_BIT, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, textureImage_24, textureImageMemory_24);

        transitionImageLayout(textureImage_24, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, mipLevels);
        ...
        generateMipmaps(textureImage_24, VK_FORMAT_R8G8B8A8_SRGB, texWidth, texHeight, mipLevels);
    }

    void generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels) {
        // Check if image format supports linear blitting
        VkFormatProperties formatProperties;
        vkGetPhysicalDeviceFormatProperties(gbl_03_physicalDevice, imageFormat, &formatProperties);
    ...
    VkSampleCountFlagBits getMaxUsableSampleCount() {
        ...
        vkGetPhysicalDeviceProperties(gbl_03_physicalDevice, &physicalDeviceProperties);
    ...
    void createTextureImageView_26() {
        textureImageView_25 = createImageView(textureImage_24, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT, mipLevels);
    }
    ...
    void loadModel() {
        ...
        std::unordered_map<Vertex_18, uint32_t> uniqueVertices{};
