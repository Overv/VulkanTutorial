...
struct SwapChainSupportDetails_06 { //Vk-SwapChain-Support-Details
...
private:
    ...
    void createGraphicsPipeline_08() {
        ...
        VkShaderModule a_vertShaderModule = createShaderModule_09(vertShaderCode);
        VkShaderModule a_fragShaderModule = createShaderModule_09(fragShaderCode);

        //Vk-Pipeline-ShaderStage-CreateInfo(1/3)
        VkPipelineShaderStageCreateInfo vertShaderStageInfo{};   //-ShaderStage- 1
        vertShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO; //-ShaderStage-2
        vertShaderStageInfo.stage = VK_SHADER_STAGE_VERTEX_BIT;  //-ShaderStage-3
        vertShaderStageInfo.module = a_vertShaderModule;  //-ShaderStage-4
        vertShaderStageInfo.pName = "main"; //-ShaderStage-5

        //Vk-Pipeline-ShaderStage-CreateInfo(2/3)
        VkPipelineShaderStageCreateInfo fragShaderStageInfo{}; //-ShaderStage-6
        fragShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;    //-ShaderStage-7
        fragShaderStageInfo.stage = VK_SHADER_STAGE_FRAGMENT_BIT;                   //-ShaderStage-8
        fragShaderStageInfo.module = a_fragShaderModule;                       //-ShaderStage-9
        fragShaderStageInfo.pName = "main"; //-ShaderStage-10

        //Vk-Pipeline-ShaderStage-CreateInfo(3/3)
        VkPipelineShaderStageCreateInfo shaderStages[] = {vertShaderStageInfo, fragShaderStageInfo}; //11..14

        //Vk-Pipeline-VertexInputState-CreateInfo
        VkPipelineVertexInputStateCreateInfo vertexInputInfo{};
        vertexInputInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO;
        vertexInputInfo.vertexBindingDescriptionCount = 0;
        vertexInputInfo.vertexAttributeDescriptionCount = 0;

        //Vk-Pipeline-InputAssemblyState-CreateInfo
        VkPipelineInputAssemblyStateCreateInfo inputAssembly{};
        inputAssembly.sType = VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO;
        inputAssembly.topology = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST;
        inputAssembly.primitiveRestartEnable = VK_FALSE;

        //Vk-Pipeline-ViewportState-CreateInfo
        VkPipelineViewportStateCreateInfo viewportState{};
        viewportState.sType = VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO;
        viewportState.viewportCount = 1;
        viewportState.scissorCount = 1;

        //Vk-Pipeline-RasterizationState-CreateInfo
        ...
        //Vk-Pipeline-MultisampleState-CreateInfo
        VkPipelineMultisampleStateCreateInfo multisampling{};
        multisampling.sType = VK_STRUCTURE_TYPE_PIPELINE_MULTISAMPLE_STATE_CREATE_INFO;
        multisampling.sampleShadingEnable = VK_FALSE;
        multisampling.rasterizationSamples = VK_SAMPLE_COUNT_1_BIT;

        //Vk-Pipeline-ColorBlendAttachmentState
        VkPipelineColorBlendAttachmentState colorBlendAttachment{};
        colorBlendAttachment.colorWriteMask = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT | VK_COLOR_COMPONENT_A_BIT;
        colorBlendAttachment.blendEnable = VK_FALSE;

        //Vk-Pipeline-ColorBlendState-CreateInfo
        ...
        //Vk-Pipeline-DynamicState-CreateInfo
        VkPipelineDynamicStateCreateInfo dynamicState{};
        dynamicState.sType = VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO;
        dynamicState.dynamicStateCount = static_cast<uint32_t>(dynamicStates.size());
        dynamicState.pDynamicStates = dynamicStates.data();

        //Vk-Pipeline-Layout-CreateInfo
