...
private:
    ...
    void createGraphicsPipeline_08() {
        ...
        //The stageCount field is set to 2, indicating that there are two shader stages (vertex and fragment shaders) in the pipeline.
        //The pStages field points to an array of VkPipelineShaderStageCreateInfo structures that describe these shader stages.
