...
// Include the GLM library for mathematics operations
#include <glm/glm.hpp>
...
#include <cstdint>
#include <limits>
// Include the array header from the C++ Standard Library
#include <array>
#include <optional>
#include <set>
...
struct Vertex_18 {
     ...
     *
     * This function creates and returns a VkVertexInputBindingDescription structure
     * that describes the rate at which vertex data is consumed by the graphics pipeline.
     *
     * @return VkVertexInputBindingDescription The binding description.
     */
    static VkVertexInputBindingDescription getBindingDescription() {
        VkVertexInputBindingDescription bindingDescription{};
        bindingDescription.binding = 0; ///< Binding index for the vertex buffer.
        bindingDescription.stride = sizeof(Vertex_18); ///< Byte offset between consecutive vertex attributes.
        bindingDescription.inputRate = VK_VERTEX_INPUT_RATE_VERTEX; ///< Specifies that the vertex data is per-vertex data.
     ...
     *
     * This function creates and returns an array of VkVertexInputAttributeDescription structures
     * that describe the attributes of the vertex input, including their binding, location, format, and offset.
     *
    ...
    static std::array<VkVertexInputAttributeDescription, 2> getAttributeDescriptions() {
        ...
        attributeDescriptions[0].binding = 0; ///< Binding index for the position attribute.
        attributeDescriptions[0].location = 0; ///< Location of the position attribute in the shader.
        attributeDescriptions[0].format = VK_FORMAT_R32G32_SFLOAT; ///< Format of the position attribute (2-component vector of 32-bit floats).
        attributeDescriptions[0].offset = offsetof(Vertex_18, pos); ///< Offset of the position attribute within the Vertex structure.

        attributeDescriptions[1].binding = 0; ///< Binding index for the color attribute.
        attributeDescriptions[1].location = 1; ///< Location of the color attribute in the shader.
        attributeDescriptions[1].format = VK_FORMAT_R32G32B32_SFLOAT; ///< Format of the color attribute (3-component vector of 32-bit floats).
        attributeDescriptions[1].offset = offsetof(Vertex_18, color); ///< Offset of the color attribute within the Vertex structure.
...
/**
 * @brief A list of vertices with predefined positions and colors.
 */
const std::vector<Vertex_18> vertices_19 = {
    {{0.0f, -0.5f}, {1.0f, 0.0f, 0.0f}}, ///< Vertex 1: Position (0.0, -0.5), Color (1.0, 0.0, 0.0)
    {{0.5f, 0.5f}, {0.0f, 1.0f, 0.0f}},  ///< Vertex 2: Position (0.5, 0.5), Color (0.0, 1.0, 0.0)
    {{-0.5f, 0.5f}, {0.0f, 0.0f, 1.0f}}  ///< Vertex 3: Position (-0.5, 0.5), Color (0.0, 0.0, 1.0)
};
...
// Retrieve the binding description for the vertex input.
auto bindingDescription = Vertex_18::getBindingDescription();

// Retrieve the attribute descriptions for the vertex input.
auto attributeDescriptions = Vertex_18::getAttributeDescriptions();

// Set the number of vertex binding descriptions.
vertexInputInfo.vertexBindingDescriptionCount = 1;

// Set the number of vertex attribute descriptions.
vertexInputInfo.vertexAttributeDescriptionCount = static_cast<uint32_t>(attributeDescriptions.size());

// Set the pointer to the vertex binding descriptions.
vertexInputInfo.pVertexBindingDescriptions = &bindingDescription;

// Set the pointer to the vertex attribute descriptions.
