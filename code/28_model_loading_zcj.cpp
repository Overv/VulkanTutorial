...
#define GLM_ENABLE_EXPERIMENTAL   //28, however, not used
#include <glm/glm.hpp>
#include <glm/gtc/matrix_transform.hpp>
#include <glm/gtx/hash.hpp>  //28

#define STB_IMAGE_IMPLEMENTATION
#include <stb_image.h>

#define TINYOBJLOADER_IMPLEMENTATION    //28, not used
#include <tiny_obj_loader.h>    //28
...
const std::string MODEL_PATH = "models/viking_room.obj";  //28
const std::string TEXTURE_PATH = "textures/viking_room.png";   //28
...
struct Vertex_18 {
    ...
    /**
 * Equality operator for Vertex_18 structure.
 *
 * @param other The other Vertex_18 instance to compare with.
 * @return True if the position, color, and texture coordinates are equal; otherwise, false.
 */
