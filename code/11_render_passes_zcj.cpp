...
private:
    ...
    ///
    /// This global variable holds the Vulkan render pass object, which defines the
    /// structure and behavior of the rendering process in the Vulkan pipeline.

    VkRenderPass gbl_11_renderPass;  //-4cj- typically involving the drawing of objects to the framebuffer
    ...
    void createSwapChain_06() {
        ...
        // The swap chain is the chain of images that the GPU will render to before showing it on the screen
        ...
        //swapChainSupport.formats = availableFormats
        VkPresentModeKHR presentMode = chooseSwapPresentMode(swapChainSupport.presentModes);
        //swapChainSupport.presentModes = availablePresentModes
    ...
    void createImageView_S_07() {
        ...
        for (size_t i = 0; i < gbl_06_swapChainImages.size(); i++) {
            ...
            createInfo.format = gbl_06_swapChainImageFormat;   //gbl_06_swapChainImageFormat = surfaceFormat.format;
    ...
    void createRenderPass_11() {
        ...
        //
        colorAttachment.format = gbl_06_swapChainImageFormat; //gbl_06_swapChainImageFormat = surfaceFormat.format;
